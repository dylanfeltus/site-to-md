export function Footer() {
  const links = [
    ...
    {
      label: 'npm',
      href: 'https://www.npmjs.com/package/site-to-md',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M0 0v24h24V0H0zm21.429 18.571H12v-12h9.429v12zm-12-12H2.571v12h6.858v-9.429H9.43v12z"/>
        </svg>
      ),
    },
    {
